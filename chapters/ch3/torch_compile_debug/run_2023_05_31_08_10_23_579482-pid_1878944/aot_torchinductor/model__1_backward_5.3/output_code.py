...
def call(args):
    ...
    args.clear()
    buf0 = empty_strided((48, 512), (512, 1), device='cpu', dtype=torch.float32)
    ...
    del tangents_1
    buf3 = empty_strided((48, 3136), (3136, 1), device='cpu', dtype=torch.float32)
    ...
    buf6 = empty_strided((48, 64, 14, 14), (12544, 196, 14, 1), device='cpu', dtype=torch.float32)
    ...
    del primals_3
    buf8 = buf7[0]
    assert_size_stride(buf8, (48, 32, 14, 14), (6272, 196, 14, 1))
    buf9 = buf7[1]
    assert_size_stride(buf9, (64, 32, 3, 3), (288, 9, 3, 1))
    buf10 = buf7[2]
    assert_size_stride(buf10, (64, ), (1, ))
    del buf7
    buf11 = empty_strided((48, 32, 28, 28), (25088, 784, 28, 1), device='cpu', dtype=torch.float32)
...
if __name__ == "__main__":
    ...
    relu = rand_strided((48, 32, 28, 28), (25088, 784, 28, 1), device='cpu', dtype=torch.float32)
    getitem = rand_strided((48, 32, 14, 14), (6272, 196, 14, 1), device='cpu', dtype=torch.float32)
    getitem_1 = rand_strided((48, 32, 14, 14), (6272, 196, 14, 1), device='cpu', dtype=torch.int64)
    relu_1 = rand_strided((48, 64, 14, 14), (12544, 196, 14, 1), device='cpu', dtype=torch.float32)
    getitem_3 = rand_strided((48, 64, 7, 7), (3136, 49, 7, 1), device='cpu', dtype=torch.int64)
    view = rand_strided((48, 3136), (3136, 1), device='cpu', dtype=torch.float32)
    addmm = rand_strided((48, 512), (512, 1), device='cpu', dtype=torch.float32)
    ...
    tangents_1 = rand_strided((48, 10), (10, 1), device='cpu', dtype=torch.float32)

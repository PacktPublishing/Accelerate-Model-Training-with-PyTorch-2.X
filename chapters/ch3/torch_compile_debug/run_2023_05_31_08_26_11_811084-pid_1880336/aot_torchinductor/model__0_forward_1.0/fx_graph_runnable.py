...
class Repro(torch.nn.Module):
    ...
    def forward(self, primals_1, primals_2, primals_3, primals_4, primals_5, primals_6, primals_7, primals_8, primals_9, primals_10, primals_11, primals_12, primals_13, primals_14, primals_15, primals_16, primals_17, primals_18, primals_19, primals_20, primals_21, primals_22, primals_23, primals_24, primals_25, primals_26, primals_27, primals_28, primals_29, primals_30, primals_31, primals_32, primals_33, primals_34, primals_35, primals_36, primals_37, primals_38, primals_39, primals_40, primals_41, primals_42, primals_43, primals_44, primals_45, primals_46, primals_47, primals_48, primals_49, primals_50, primals_51, primals_52, primals_53, primals_54, primals_55, primals_56, primals_57, primals_58, primals_59, primals_60, primals_61, primals_62, primals_63, primals_64, primals_65, primals_66, primals_67, primals_68, primals_69, primals_70, primals_71, primals_72, primals_73, primals_74, primals_75, primals_76, primals_77, primals_78, primals_79, primals_80, primals_81, primals_82, primals_83, primals_84, primals_85, primals_86, primals_87, primals_88, primals_89, primals_90, primals_91, primals_92, primals_93, primals_94, primals_95, primals_96, primals_97, primals_98, primals_99, primals_100, primals_101, primals_102, primals_103, primals_104, primals_105, primals_106, primals_107, primals_108, primals_109, primals_110, primals_111, primals_112, primals_113, primals_114, primals_115, primals_116, primals_117, primals_118, primals_119, primals_120, primals_121, primals_122, primals_123, primals_124, primals_125, primals_126, primals_127, primals_128, primals_129, primals_130, primals_131, primals_132, primals_133, primals_134, primals_135, primals_136, primals_137, primals_138, primals_139, primals_140, primals_141, primals_142, primals_143, primals_144, primals_145, primals_146, primals_147, primals_148, primals_149, primals_150, primals_151, primals_152, primals_153, primals_154, primals_155, primals_156, primals_157, primals_158, primals_159, primals_160, primals_161, primals_162, primals_163, primals_164, primals_165, primals_166, primals_167, primals_168, primals_169, primals_170, primals_171, primals_172, primals_173, primals_174, primals_175, primals_176, primals_177, primals_178, primals_179, primals_180, primals_181, primals_182, primals_183, primals_184, primals_185, primals_186, primals_187, primals_188, primals_189, primals_190, primals_191, primals_192, primals_193, primals_194, primals_195, primals_196, primals_197, primals_198, primals_199, primals_200, primals_201, primals_202, primals_203, primals_204, primals_205, primals_206, primals_207, primals_208, primals_209, primals_210, primals_211, primals_212, primals_213, primals_214, primals_215, primals_216, primals_217, primals_218, primals_219, primals_220, primals_221, primals_222, primals_223, primals_224, primals_225, primals_226, primals_227, primals_228, primals_229, primals_230, primals_231, primals_232, primals_233, primals_234, primals_235, primals_236, primals_237, primals_238, primals_239, primals_240, primals_241, primals_242, primals_243, primals_244, primals_245, primals_246, primals_247, primals_248, primals_249, primals_250, primals_251, primals_252, primals_253, primals_254, primals_255, primals_256, primals_257, primals_258, primals_259, primals_260, primals_261, primals_262, primals_263, primals_264, primals_265, primals_266, primals_267, primals_268, primals_269, primals_270, primals_271, primals_272, primals_273, primals_274, primals_275, primals_276, primals_277, primals_278, primals_279, primals_280, primals_281, primals_282, primals_283, primals_284, primals_285, primals_286, primals_287, primals_288, primals_289, primals_290, primals_291, primals_292, primals_293, primals_294, primals_295, primals_296, primals_297, primals_298, primals_299, primals_300, primals_301, primals_302, primals_303, primals_304, primals_305, primals_306, primals_307, primals_308, primals_309, primals_310, primals_311, primals_312, primals_313, primals_314, primals_315, primals_316, primals_317, primals_318, primals_319, primals_320, primals_321):
        ...
        mul_3 = torch.ops.aten.mul.Tensor(squeeze_2, 1.0000610388817677);  squeeze_2 = None
        ...
        mul_10 = torch.ops.aten.mul.Tensor(squeeze_5, 1.0002442002442002);  squeeze_5 = None
        ...
        mul_17 = torch.ops.aten.mul.Tensor(squeeze_8, 1.0002442002442002);  squeeze_8 = None
        ...
        mul_24 = torch.ops.aten.mul.Tensor(squeeze_11, 1.0002442002442002);  squeeze_11 = None
        ...
        mul_31 = torch.ops.aten.mul.Tensor(squeeze_14, 1.0002442002442002);  squeeze_14 = None
        ...
        mul_38 = torch.ops.aten.mul.Tensor(squeeze_17, 1.0002442002442002);  squeeze_17 = None
        ...
        mul_45 = torch.ops.aten.mul.Tensor(squeeze_20, 1.0002442002442002);  squeeze_20 = None
        ...
        mul_52 = torch.ops.aten.mul.Tensor(squeeze_23, 1.0002442002442002);  squeeze_23 = None
        ...
        mul_59 = torch.ops.aten.mul.Tensor(squeeze_26, 1.0002442002442002);  squeeze_26 = None
        ...
        mul_66 = torch.ops.aten.mul.Tensor(squeeze_29, 1.0002442002442002);  squeeze_29 = None
        ...
        mul_73 = torch.ops.aten.mul.Tensor(squeeze_32, 1.0002442002442002);  squeeze_32 = None
        ...
        mul_80 = torch.ops.aten.mul.Tensor(squeeze_35, 1.0002442002442002);  squeeze_35 = None
        ...
        mul_87 = torch.ops.aten.mul.Tensor(squeeze_38, 1.0009775171065494);  squeeze_38 = None
        ...
        mul_94 = torch.ops.aten.mul.Tensor(squeeze_41, 1.0009775171065494);  squeeze_41 = None
        ...
        mul_101 = torch.ops.aten.mul.Tensor(squeeze_44, 1.0009775171065494);  squeeze_44 = None
        ...
        mul_108 = torch.ops.aten.mul.Tensor(squeeze_47, 1.0009775171065494);  squeeze_47 = None
        ...
        mul_115 = torch.ops.aten.mul.Tensor(squeeze_50, 1.0009775171065494);  squeeze_50 = None
        ...
        mul_122 = torch.ops.aten.mul.Tensor(squeeze_53, 1.0009775171065494);  squeeze_53 = None
        ...
        mul_129 = torch.ops.aten.mul.Tensor(squeeze_56, 1.0009775171065494);  squeeze_56 = None
        ...
        mul_136 = torch.ops.aten.mul.Tensor(squeeze_59, 1.0009775171065494);  squeeze_59 = None
        ...
        mul_143 = torch.ops.aten.mul.Tensor(squeeze_62, 1.0009775171065494);  squeeze_62 = None
        ...
        mul_150 = torch.ops.aten.mul.Tensor(squeeze_65, 1.0009775171065494);  squeeze_65 = None
        ...
        mul_157 = torch.ops.aten.mul.Tensor(squeeze_68, 1.0009775171065494);  squeeze_68 = None
        ...
        mul_164 = torch.ops.aten.mul.Tensor(squeeze_71, 1.0009775171065494);  squeeze_71 = None
        ...
        mul_171 = torch.ops.aten.mul.Tensor(squeeze_74, 1.0009775171065494);  squeeze_74 = None
        ...
        mul_178 = torch.ops.aten.mul.Tensor(squeeze_77, 1.003921568627451);  squeeze_77 = None
        ...
        mul_185 = torch.ops.aten.mul.Tensor(squeeze_80, 1.003921568627451);  squeeze_80 = None
        ...
        mul_192 = torch.ops.aten.mul.Tensor(squeeze_83, 1.003921568627451);  squeeze_83 = None
        ...
        mul_199 = torch.ops.aten.mul.Tensor(squeeze_86, 1.003921568627451);  squeeze_86 = None
        ...
        mul_206 = torch.ops.aten.mul.Tensor(squeeze_89, 1.003921568627451);  squeeze_89 = None
        ...
        mul_213 = torch.ops.aten.mul.Tensor(squeeze_92, 1.003921568627451);  squeeze_92 = None
        ...
        mul_220 = torch.ops.aten.mul.Tensor(squeeze_95, 1.003921568627451);  squeeze_95 = None
        ...
        mul_227 = torch.ops.aten.mul.Tensor(squeeze_98, 1.003921568627451);  squeeze_98 = None
        ...
        mul_234 = torch.ops.aten.mul.Tensor(squeeze_101, 1.003921568627451);  squeeze_101 = None
        ...
        mul_241 = torch.ops.aten.mul.Tensor(squeeze_104, 1.003921568627451);  squeeze_104 = None
        ...
        mul_248 = torch.ops.aten.mul.Tensor(squeeze_107, 1.003921568627451);  squeeze_107 = None
        ...
        mul_255 = torch.ops.aten.mul.Tensor(squeeze_110, 1.003921568627451);  squeeze_110 = None
        ...
        mul_262 = torch.ops.aten.mul.Tensor(squeeze_113, 1.003921568627451);  squeeze_113 = None
        ...
        mul_269 = torch.ops.aten.mul.Tensor(squeeze_116, 1.003921568627451);  squeeze_116 = None
        ...
        mul_276 = torch.ops.aten.mul.Tensor(squeeze_119, 1.003921568627451);  squeeze_119 = None
        ...
        mul_283 = torch.ops.aten.mul.Tensor(squeeze_122, 1.003921568627451);  squeeze_122 = None
        ...
        mul_290 = torch.ops.aten.mul.Tensor(squeeze_125, 1.003921568627451);  squeeze_125 = None
        ...
        mul_297 = torch.ops.aten.mul.Tensor(squeeze_128, 1.003921568627451);  squeeze_128 = None
        ...
        mul_304 = torch.ops.aten.mul.Tensor(squeeze_131, 1.003921568627451);  squeeze_131 = None
        ...
        mul_311 = torch.ops.aten.mul.Tensor(squeeze_134, 1.0158730158730158);  squeeze_134 = None
        ...
        mul_318 = torch.ops.aten.mul.Tensor(squeeze_137, 1.0158730158730158);  squeeze_137 = None
        ...
        mul_325 = torch.ops.aten.mul.Tensor(squeeze_140, 1.0158730158730158);  squeeze_140 = None
        ...
        mul_332 = torch.ops.aten.mul.Tensor(squeeze_143, 1.0158730158730158);  squeeze_143 = None
        ...
        mul_339 = torch.ops.aten.mul.Tensor(squeeze_146, 1.0158730158730158);  squeeze_146 = None
        ...
        mul_346 = torch.ops.aten.mul.Tensor(squeeze_149, 1.0158730158730158);  squeeze_149 = None
        ...
        mul_353 = torch.ops.aten.mul.Tensor(squeeze_152, 1.0158730158730158);  squeeze_152 = None
        ...
        mul_360 = torch.ops.aten.mul.Tensor(squeeze_155, 1.0158730158730158);  squeeze_155 = None
        ...
        mul_367 = torch.ops.aten.mul.Tensor(squeeze_158, 1.0158730158730158);  squeeze_158 = None
        ...
        view = torch.ops.aten.view.default(mean, [64, 2048]);  mean = None
...
args = [((64, 3, 7, 7), (147, 49, 7, 1), torch.float32, 'cpu'), ((64,), (1,), torch.float32, 'cpu'), ((64,), (1,), torch.float32, 'cpu'), ((64, 64, 1, 1), (64, 1, 1, 1), torch.float32, 'cpu'), ((64,), (1,), torch.float32, 'cpu'), ((64,), (1,), torch.float32, 'cpu'), ((64, 64, 3, 3), (576, 9, 3, 1), torch.float32, 'cpu'), ((64,), (1,), torch.float32, 'cpu'), ((64,), (1,), torch.float32, 'cpu'), ((256, 64, 1, 1), (64, 1, 1, 1), torch.float32, 'cpu'), ((256,), (1,), torch.float32, 'cpu'), ((256,), (1,), torch.float32, 'cpu'), ((256, 64, 1, 1), (64, 1, 1, 1), torch.float32, 'cpu'), ((256,), (1,), torch.float32, 'cpu'), ((256,), (1,), torch.float32, 'cpu'), ((64, 256, 1, 1), (256, 1, 1, 1), torch.float32, 'cpu'), ((64,), (1,), torch.float32, 'cpu'), ((64,), (1,), torch.float32, 'cpu'), ((64, 64, 3, 3), (576, 9, 3, 1), torch.float32, 'cpu'), ((64,), (1,), torch.float32, 'cpu'), ((64,), (1,), torch.float32, 'cpu'), ((256, 64, 1, 1), (64, 1, 1, 1), torch.float32, 'cpu'), ((256,), (1,), torch.float32, 'cpu'), ((256,), (1,), torch.float32, 'cpu'), ((64, 256, 1, 1), (256, 1, 1, 1), torch.float32, 'cpu'), ((64,), (1,), torch.float32, 'cpu'), ((64,), (1,), torch.float32, 'cpu'), ((64, 64, 3, 3), (576, 9, 3, 1), torch.float32, 'cpu'), ((64,), (1,), torch.float32, 'cpu'), ((64,), (1,), torch.float32, 'cpu'), ((256, 64, 1, 1), (64, 1, 1, 1), torch.float32, 'cpu'), ((256,), (1,), torch.float32, 'cpu'), ((256,), (1,), torch.float32, 'cpu'), ((128, 256, 1, 1), (256, 1, 1, 1), torch.float32, 'cpu'), ((128,), (1,), torch.float32, 'cpu'), ((128,), (1,), torch.float32, 'cpu'), ((128, 128, 3, 3), (1152, 9, 3, 1), torch.float32, 'cpu'), ((128,), (1,), torch.float32, 'cpu'), ((128,), (1,), torch.float32, 'cpu'), ((512, 128, 1, 1), (128, 1, 1, 1), torch.float32, 'cpu'), ((512,), (1,), torch.float32, 'cpu'), ((512,), (1,), torch.float32, 'cpu'), ((512, 256, 1, 1), (256, 1, 1, 1), torch.float32, 'cpu'), ((512,), (1,), torch.float32, 'cpu'), ((512,), (1,), torch.float32, 'cpu'), ((128, 512, 1, 1), (512, 1, 1, 1), torch.float32, 'cpu'), ((128,), (1,), torch.float32, 'cpu'), ((128,), (1,), torch.float32, 'cpu'), ((128, 128, 3, 3), (1152, 9, 3, 1), torch.float32, 'cpu'), ((128,), (1,), torch.float32, 'cpu'), ((128,), (1,), torch.float32, 'cpu'), ((512, 128, 1, 1), (128, 1, 1, 1), torch.float32, 'cpu'), ((512,), (1,), torch.float32, 'cpu'), ((512,), (1,), torch.float32, 'cpu'), ((128, 512, 1, 1), (512, 1, 1, 1), torch.float32, 'cpu'), ((128,), (1,), torch.float32, 'cpu'), ((128,), (1,), torch.float32, 'cpu'), ((128, 128, 3, 3), (1152, 9, 3, 1), torch.float32, 'cpu'), ((128,), (1,), torch.float32, 'cpu'), ((128,), (1,), torch.float32, 'cpu'), ((512, 128, 1, 1), (128, 1, 1, 1), torch.float32, 'cpu'), ((512,), (1,), torch.float32, 'cpu'), ((512,), (1,), torch.float32, 'cpu'), ((128, 512, 1, 1), (512, 1, 1, 1), torch.float32, 'cpu'), ((128,), (1,), torch.float32, 'cpu'), ((128,), (1,), torch.float32, 'cpu'), ((128, 128, 3, 3), (1152, 9, 3, 1), torch.float32, 'cpu'), ((128,), (1,), torch.float32, 'cpu'), ((128,), (1,), torch.float32, 'cpu'), ((512, 128, 1, 1), (128, 1, 1, 1), torch.float32, 'cpu'), ((512,), (1,), torch.float32, 'cpu'), ((512,), (1,), torch.float32, 'cpu'), ((256, 512, 1, 1), (512, 1, 1, 1), torch.float32, 'cpu'), ((256,), (1,), torch.float32, 'cpu'), ((256,), (1,), torch.float32, 'cpu'), ((256, 256, 3, 3), (2304, 9, 3, 1), torch.float32, 'cpu'), ((256,), (1,), torch.float32, 'cpu'), ((256,), (1,), torch.float32, 'cpu'), ((1024, 256, 1, 1), (256, 1, 1, 1), torch.float32, 'cpu'), ((1024,), (1,), torch.float32, 'cpu'), ((1024,), (1,), torch.float32, 'cpu'), ((1024, 512, 1, 1), (512, 1, 1, 1), torch.float32, 'cpu'), ((1024,), (1,), torch.float32, 'cpu'), ((1024,), (1,), torch.float32, 'cpu'), ((256, 1024, 1, 1), (1024, 1, 1, 1), torch.float32, 'cpu'), ((256,), (1,), torch.float32, 'cpu'), ((256,), (1,), torch.float32, 'cpu'), ((256, 256, 3, 3), (2304, 9, 3, 1), torch.float32, 'cpu'), ((256,), (1,), torch.float32, 'cpu'), ((256,), (1,), torch.float32, 'cpu'), ((1024, 256, 1, 1), (256, 1, 1, 1), torch.float32, 'cpu'), ((1024,), (1,), torch.float32, 'cpu'), ((1024,), (1,), torch.float32, 'cpu'), ((256, 1024, 1, 1), (1024, 1, 1, 1), torch.float32, 'cpu'), ((256,), (1,), torch.float32, 'cpu'), ((256,), (1,), torch.float32, 'cpu'), ((256, 256, 3, 3), (2304, 9, 3, 1), torch.float32, 'cpu'), ((256,), (1,), torch.float32, 'cpu'), ((256,), (1,), torch.float32, 'cpu'), ((1024, 256, 1, 1), (256, 1, 1, 1), torch.float32, 'cpu'), ((1024,), (1,), torch.float32, 'cpu'), ((1024,), (1,), torch.float32, 'cpu'), ((256, 1024, 1, 1), (1024, 1, 1, 1), torch.float32, 'cpu'), ((256,), (1,), torch.float32, 'cpu'), ((256,), (1,), torch.float32, 'cpu'), ((256, 256, 3, 3), (2304, 9, 3, 1), torch.float32, 'cpu'), ((256,), (1,), torch.float32, 'cpu'), ((256,), (1,), torch.float32, 'cpu'), ((1024, 256, 1, 1), (256, 1, 1, 1), torch.float32, 'cpu'), ((1024,), (1,), torch.float32, 'cpu'), ((1024,), (1,), torch.float32, 'cpu'), ((256, 1024, 1, 1), (1024, 1, 1, 1), torch.float32, 'cpu'), ((256,), (1,), torch.float32, 'cpu'), ((256,), (1,), torch.float32, 'cpu'), ((256, 256, 3, 3), (2304, 9, 3, 1), torch.float32, 'cpu'), ((256,), (1,), torch.float32, 'cpu'), ((256,), (1,), torch.float32, 'cpu'), ((1024, 256, 1, 1), (256, 1, 1, 1), torch.float32, 'cpu'), ((1024,), (1,), torch.float32, 'cpu'), ((1024,), (1,), torch.float32, 'cpu'), ((256, 1024, 1, 1), (1024, 1, 1, 1), torch.float32, 'cpu'), ((256,), (1,), torch.float32, 'cpu'), ((256,), (1,), torch.float32, 'cpu'), ((256, 256, 3, 3), (2304, 9, 3, 1), torch.float32, 'cpu'), ((256,), (1,), torch.float32, 'cpu'), ((256,), (1,), torch.float32, 'cpu'), ((1024, 256, 1, 1), (256, 1, 1, 1), torch.float32, 'cpu'), ((1024,), (1,), torch.float32, 'cpu'), ((1024,), (1,), torch.float32, 'cpu'), ((512, 1024, 1, 1), (1024, 1, 1, 1), torch.float32, 'cpu'), ((512,), (1,), torch.float32, 'cpu'), ((512,), (1,), torch.float32, 'cpu'), ((512, 512, 3, 3), (4608, 9, 3, 1), torch.float32, 'cpu'), ((512,), (1,), torch.float32, 'cpu'), ((512,), (1,), torch.float32, 'cpu'), ((2048, 512, 1, 1), (512, 1, 1, 1), torch.float32, 'cpu'), ((2048,), (1,), torch.float32, 'cpu'), ((2048,), (1,), torch.float32, 'cpu'), ((2048, 1024, 1, 1), (1024, 1, 1, 1), torch.float32, 'cpu'), ((2048,), (1,), torch.float32, 'cpu'), ((2048,), (1,), torch.float32, 'cpu'), ((512, 2048, 1, 1), (2048, 1, 1, 1), torch.float32, 'cpu'), ((512,), (1,), torch.float32, 'cpu'), ((512,), (1,), torch.float32, 'cpu'), ((512, 512, 3, 3), (4608, 9, 3, 1), torch.float32, 'cpu'), ((512,), (1,), torch.float32, 'cpu'), ((512,), (1,), torch.float32, 'cpu'), ((2048, 512, 1, 1), (512, 1, 1, 1), torch.float32, 'cpu'), ((2048,), (1,), torch.float32, 'cpu'), ((2048,), (1,), torch.float32, 'cpu'), ((512, 2048, 1, 1), (2048, 1, 1, 1), torch.float32, 'cpu'), ((512,), (1,), torch.float32, 'cpu'), ((512,), (1,), torch.float32, 'cpu'), ((512, 512, 3, 3), (4608, 9, 3, 1), torch.float32, 'cpu'), ((512,), (1,), torch.float32, 'cpu'), ((512,), (1,), torch.float32, 'cpu'), ((2048, 512, 1, 1), (512, 1, 1, 1), torch.float32, 'cpu'), ((2048,), (1,), torch.float32, 'cpu'), ((2048,), (1,), torch.float32, 'cpu'), ((1000, 2048), (2048, 1), torch.float32, 'cpu'), ((1000,), (1,), torch.float32, 'cpu'), ((64,), (1,), torch.float32, 'cpu'), ((64,), (1,), torch.float32, 'cpu'), ((), (), torch.int64, 'cpu'), ((64,), (1,), torch.float32, 'cpu'), ((64,), (1,), torch.float32, 'cpu'), ((), (), torch.int64, 'cpu'), ((64,), (1,), torch.float32, 'cpu'), ((64,), (1,), torch.float32, 'cpu'), ((), (), torch.int64, 'cpu'), ((256,), (1,), torch.float32, 'cpu'), ((256,), (1,), torch.float32, 'cpu'), ((), (), torch.int64, 'cpu'), ((256,), (1,), torch.float32, 'cpu'), ((256,), (1,), torch.float32, 'cpu'), ((), (), torch.int64, 'cpu'), ((64,), (1,), torch.float32, 'cpu'), ((64,), (1,), torch.float32, 'cpu'), ((), (), torch.int64, 'cpu'), ((64,), (1,), torch.float32, 'cpu'), ((64,), (1,), torch.float32, 'cpu'), ((), (), torch.int64, 'cpu'), ((256,), (1,), torch.float32, 'cpu'), ((256,), (1,), torch.float32, 'cpu'), ((), (), torch.int64, 'cpu'), ((64,), (1,), torch.float32, 'cpu'), ((64,), (1,), torch.float32, 'cpu'), ((), (), torch.int64, 'cpu'), ((64,), (1,), torch.float32, 'cpu'), ((64,), (1,), torch.float32, 'cpu'), ((), (), torch.int64, 'cpu'), ((256,), (1,), torch.float32, 'cpu'), ((256,), (1,), torch.float32, 'cpu'), ((), (), torch.int64, 'cpu'), ((128,), (1,), torch.float32, 'cpu'), ((128,), (1,), torch.float32, 'cpu'), ((), (), torch.int64, 'cpu'), ((128,), (1,), torch.float32, 'cpu'), ((128,), (1,), torch.float32, 'cpu'), ((), (), torch.int64, 'cpu'), ((512,), (1,), torch.float32, 'cpu'), ((512,), (1,), torch.float32, 'cpu'), ((), (), torch.int64, 'cpu'), ((512,), (1,), torch.float32, 'cpu'), ((512,), (1,), torch.float32, 'cpu'), ((), (), torch.int64, 'cpu'), ((128,), (1,), torch.float32, 'cpu'), ((128,), (1,), torch.float32, 'cpu'), ((), (), torch.int64, 'cpu'), ((128,), (1,), torch.float32, 'cpu'), ((128,), (1,), torch.float32, 'cpu'), ((), (), torch.int64, 'cpu'), ((512,), (1,), torch.float32, 'cpu'), ((512,), (1,), torch.float32, 'cpu'), ((), (), torch.int64, 'cpu'), ((128,), (1,), torch.float32, 'cpu'), ((128,), (1,), torch.float32, 'cpu'), ((), (), torch.int64, 'cpu'), ((128,), (1,), torch.float32, 'cpu'), ((128,), (1,), torch.float32, 'cpu'), ((), (), torch.int64, 'cpu'), ((512,), (1,), torch.float32, 'cpu'), ((512,), (1,), torch.float32, 'cpu'), ((), (), torch.int64, 'cpu'), ((128,), (1,), torch.float32, 'cpu'), ((128,), (1,), torch.float32, 'cpu'), ((), (), torch.int64, 'cpu'), ((128,), (1,), torch.float32, 'cpu'), ((128,), (1,), torch.float32, 'cpu'), ((), (), torch.int64, 'cpu'), ((512,), (1,), torch.float32, 'cpu'), ((512,), (1,), torch.float32, 'cpu'), ((), (), torch.int64, 'cpu'), ((256,), (1,), torch.float32, 'cpu'), ((256,), (1,), torch.float32, 'cpu'), ((), (), torch.int64, 'cpu'), ((256,), (1,), torch.float32, 'cpu'), ((256,), (1,), torch.float32, 'cpu'), ((), (), torch.int64, 'cpu'), ((1024,), (1,), torch.float32, 'cpu'), ((1024,), (1,), torch.float32, 'cpu'), ((), (), torch.int64, 'cpu'), ((1024,), (1,), torch.float32, 'cpu'), ((1024,), (1,), torch.float32, 'cpu'), ((), (), torch.int64, 'cpu'), ((256,), (1,), torch.float32, 'cpu'), ((256,), (1,), torch.float32, 'cpu'), ((), (), torch.int64, 'cpu'), ((256,), (1,), torch.float32, 'cpu'), ((256,), (1,), torch.float32, 'cpu'), ((), (), torch.int64, 'cpu'), ((1024,), (1,), torch.float32, 'cpu'), ((1024,), (1,), torch.float32, 'cpu'), ((), (), torch.int64, 'cpu'), ((256,), (1,), torch.float32, 'cpu'), ((256,), (1,), torch.float32, 'cpu'), ((), (), torch.int64, 'cpu'), ((256,), (1,), torch.float32, 'cpu'), ((256,), (1,), torch.float32, 'cpu'), ((), (), torch.int64, 'cpu'), ((1024,), (1,), torch.float32, 'cpu'), ((1024,), (1,), torch.float32, 'cpu'), ((), (), torch.int64, 'cpu'), ((256,), (1,), torch.float32, 'cpu'), ((256,), (1,), torch.float32, 'cpu'), ((), (), torch.int64, 'cpu'), ((256,), (1,), torch.float32, 'cpu'), ((256,), (1,), torch.float32, 'cpu'), ((), (), torch.int64, 'cpu'), ((1024,), (1,), torch.float32, 'cpu'), ((1024,), (1,), torch.float32, 'cpu'), ((), (), torch.int64, 'cpu'), ((256,), (1,), torch.float32, 'cpu'), ((256,), (1,), torch.float32, 'cpu'), ((), (), torch.int64, 'cpu'), ((256,), (1,), torch.float32, 'cpu'), ((256,), (1,), torch.float32, 'cpu'), ((), (), torch.int64, 'cpu'), ((1024,), (1,), torch.float32, 'cpu'), ((1024,), (1,), torch.float32, 'cpu'), ((), (), torch.int64, 'cpu'), ((256,), (1,), torch.float32, 'cpu'), ((256,), (1,), torch.float32, 'cpu'), ((), (), torch.int64, 'cpu'), ((256,), (1,), torch.float32, 'cpu'), ((256,), (1,), torch.float32, 'cpu'), ((), (), torch.int64, 'cpu'), ((1024,), (1,), torch.float32, 'cpu'), ((1024,), (1,), torch.float32, 'cpu'), ((), (), torch.int64, 'cpu'), ((512,), (1,), torch.float32, 'cpu'), ((512,), (1,), torch.float32, 'cpu'), ((), (), torch.int64, 'cpu'), ((512,), (1,), torch.float32, 'cpu'), ((512,), (1,), torch.float32, 'cpu'), ((), (), torch.int64, 'cpu'), ((2048,), (1,), torch.float32, 'cpu'), ((2048,), (1,), torch.float32, 'cpu'), ((), (), torch.int64, 'cpu'), ((2048,), (1,), torch.float32, 'cpu'), ((2048,), (1,), torch.float32, 'cpu'), ((), (), torch.int64, 'cpu'), ((512,), (1,), torch.float32, 'cpu'), ((512,), (1,), torch.float32, 'cpu'), ((), (), torch.int64, 'cpu'), ((512,), (1,), torch.float32, 'cpu'), ((512,), (1,), torch.float32, 'cpu'), ((), (), torch.int64, 'cpu'), ((2048,), (1,), torch.float32, 'cpu'), ((2048,), (1,), torch.float32, 'cpu'), ((), (), torch.int64, 'cpu'), ((512,), (1,), torch.float32, 'cpu'), ((512,), (1,), torch.float32, 'cpu'), ((), (), torch.int64, 'cpu'), ((512,), (1,), torch.float32, 'cpu'), ((512,), (1,), torch.float32, 'cpu'), ((), (), torch.int64, 'cpu'), ((2048,), (1,), torch.float32, 'cpu'), ((2048,), (1,), torch.float32, 'cpu'), ((), (), torch.int64, 'cpu'), ((64, 3, 32, 32), (3072, 1024, 32, 1), torch.float32, 'cpu')]

...
class Repro(torch.nn.Module):
    ...
    def forward(self, primals_1, primals_2, primals_3, primals_4, primals_5, primals_6, primals_7, primals_8, primals_9):
        ...
        view = torch.ops.aten.view.default(getitem_2, [64, 3136]);  getitem_2 = None
...
args = [((32, 1, 3, 3), (9, 9, 3, 1), torch.float32, 'cpu'), ((32,), (1,), torch.float32, 'cpu'), ((64, 32, 3, 3), (288, 9, 3, 1), torch.float32, 'cpu'), ((64,), (1,), torch.float32, 'cpu'), ((512, 3136), (3136, 1), torch.float32, 'cpu'), ((512,), (1,), torch.float32, 'cpu'), ((10, 512), (512, 1), torch.float32, 'cpu'), ((10,), (1,), torch.float32, 'cpu'), ((64, 1, 28, 28), (784, 784, 28, 1), torch.float32, 'cpu')]

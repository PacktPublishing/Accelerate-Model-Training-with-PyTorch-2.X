...
class Repro(torch.nn.Module):
    ...
    def forward(self, primals_1, primals_3, primals_9, relu, getitem, getitem_1, relu_1, getitem_3, view, addmm, permute_2, permute_6, tangents_1):
        ...
        view_3 = torch.ops.aten.view.default(mm_2, [64, 64, 7, 7]);  mm_2 = None
        ...
        getitem_5 = convolution_backward[1];  convolution_backward = None
        ...
        getitem_8 = convolution_backward_1[1];  convolution_backward_1 = None
        return [getitem_8, sum_4, getitem_5, sum_3, permute_9, view_2, permute_5, view_1, None]
        
args = [((32, 1, 3, 3), (9, 9, 3, 1), torch.float32, 'cuda'), ((64, 32, 3, 3), (288, 9, 3, 1), torch.float32, 'cuda'), ((64, 1, 28, 28), (784, 784, 28, 1), torch.float32, 'cuda'), ((64, 32, 28, 28), (25088, 784, 28, 1), torch.float32, 'cuda'), ((64, 32, 14, 14), (6272, 196, 14, 1), torch.float32, 'cuda'), ((64, 32, 14, 14), (6272, 196, 14, 1), torch.int64, 'cuda'), ((64, 64, 14, 14), (12544, 196, 14, 1), torch.float32, 'cuda'), ((64, 64, 7, 7), (3136, 49, 7, 1), torch.int64, 'cuda'), ((64, 3136), (3136, 1), torch.float32, 'cuda'), ((64, 512), (512, 1), torch.float32, 'cuda'), ((10, 512), (512, 1), torch.float32, 'cuda'), ((512, 3136), (3136, 1), torch.float32, 'cuda'), ((64, 10), (10, 1), torch.float32, 'cuda')]

class GraphModule(torch.nn.Module):
    def forward(self, primals_1: f32[32, 1, 3, 3], primals_2: f32[32], primals_3: f32[64, 32, 3, 3], primals_4: f32[64], primals_5: f32[512, 3136], primals_6: f32[512], primals_7: f32[10, 512], primals_8: f32[10], primals_9: f32[64, 1, 28, 28]):
        # File: /tmp/ipykernel_2341616/3432332073.py:19, code: out = self.layer1(x)
        ...
        # File: /tmp/ipykernel_2341616/3432332073.py:20, code: out = self.layer2(out)
        ...
        # File: /tmp/ipykernel_2341616/3432332073.py:21, code: out = out.reshape(out.size(0), -1)
        view: f32[64, 3136] = torch.ops.aten.view.default(getitem_2, [64, 3136]);  getitem_2 = None
        
        # File: /tmp/ipykernel_2341616/3432332073.py:22, code: out = self.fc1(out)
        ...
        # File: /tmp/ipykernel_2341616/3432332073.py:23, code: out = self.fc2(out)

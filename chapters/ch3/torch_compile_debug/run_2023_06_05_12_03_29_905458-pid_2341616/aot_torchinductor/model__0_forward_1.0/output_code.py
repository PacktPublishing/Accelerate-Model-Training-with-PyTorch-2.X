    ...
    {
        {
            ...
            for(long i0=1605632; i0<1605632; i0+=1)
            {
    ...
    {
        {
            ...
            #pragma omp for simd simdlen(8) 
            for(long i0=802816; i0<802816; i0+=1)
            {
                auto tmp0 = in_out_ptr0[i0];
                auto tmp1 = tmp0 * (tmp0>0);
                in_out_ptr0[i0] = tmp1;
...
def call(args):
    ...
    buf2 = empty_strided((64, 32, 14, 14), (6272, 196, 14, 1), device='cpu', dtype=torch.float32)
    buf3 = empty_strided((64, 32, 14, 14), (6272, 196, 14, 1), device='cpu', dtype=torch.int64)
    ...
    buf6 = empty_strided((64, 64, 7, 7), (3136, 49, 7, 1), device='cpu', dtype=torch.int64)
    buf7 = empty_strided((64, 3136), (3136, 1), device='cpu', dtype=torch.float32)
    kernel_cpp_1(c_void_p(buf5.data_ptr()), c_void_p(buf6.data_ptr()), c_void_p(buf7.data_ptr()))
    buf8 = empty_strided((64, 512), (512, 1), device='cpu', dtype=torch.float32)
    extern_kernels.addmm(primals_6, buf7, as_strided(primals_5, (3136, 512), (1, 3136)), alpha=1, beta=1, out=buf8)
    del primals_6
    buf9 = empty_strided((64, 10), (10, 1), device='cpu', dtype=torch.float32)
